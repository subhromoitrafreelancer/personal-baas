...
The compose overlay references three images by tag — `personal-baas-control-server:0.7.0`,
...
| Variable | Meaning |
| --- | --- |
| `BAAS_CONTROL_SERVER_IMAGE` | control-server image tag (default `personal-baas-control-server:0.7.0`) |
